...
\begin{figure}[htbp]
	\centering
%	\includegraphics{schematic_complete}
...
\begin{figure}[htbp]
	\centering
%	\includegraphics{simulation_functional}
	\caption{Functional simulation of a half adder}
	\label{fig:simulation_functional}
\end{figure}

\begin{figure}[htbp]
	\centering
%	\includegraphics{verilog}
	\caption{Verilog implementation of the half adder}
	\label{fig:verilog}
\end{figure}
...
%	\caption{Results of the post place-and-route timing simulation}
%	\label{fig:timing}
%\end{figure}
